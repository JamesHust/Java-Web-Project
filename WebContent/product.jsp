...
<body>
	...
	<div class="section">
		<div class="top-banner">
			<img src="img/banner/topic-banner/banner6.jpg" alt="">
		</div>
		<div class="title-product-demo" style="margin-top: 9vh; width: 50%;">
			<span><%=request.getAttribute("nameSelect")%></span>
		</div>
		<div class="content-detail">
			<div class="list-product">
				<c:forEach var="tempProduct" items="${TEMP_PRODUCT}">
					...
					<div class="detail-product">
						<div class="img-product">
							<img src="${tempProduct.prod_img1}" alt="product1">
						</div>
